      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed right-0 top-0 sm:top-auto sm:bottom-0 h-screen sm:h-auto w-full sm:w-96 bg-card border-l border-border shadow-2xl z-50 overflow-y-auto rounded-t-lg sm:rounded-t-none"
          >
